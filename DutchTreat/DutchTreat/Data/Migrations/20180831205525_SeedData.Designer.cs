...
{
    [DbContext(typeof(DutchContex))]
    [Migration("20180831205525_SeedData")]
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, OrderDate = new DateTime(2018, 8, 31, 21, 55, 25, 60, DateTimeKind.Local), OrderNumber = "12354" }
                    );
                });
